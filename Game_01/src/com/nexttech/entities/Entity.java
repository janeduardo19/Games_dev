...
public class Entity {
	...
	public static BufferedImage ENEMY_FEEDBACK = Game.spritesheet.getSprite(0, 32, 16, 16);
	public static BufferedImage ENEMY_FEEDBACK2 = Game.spritesheet.getSprite(16, 32, 16, 16);
